...
import 'package:lab10_tarea/screens/cart/cart_screen.dart';
import 'package:lab10_tarea/screens/product/widgets/item_color.dart';
import 'package:lab10_tarea/screens/product/widgets/item_size.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text('Producto disponible', style: Theme.of(context).textTheme.headlineLarge,),
                RichText(
                  text: TextSpan(
                      style: const TextStyle(color: Colors.black87),
                      children: [
                        TextSpan(text: 's/. 1500\t\t', style: Theme.of(context).textTheme.titleLarge),
                        TextSpan(
                            text: 's/. 1800',
